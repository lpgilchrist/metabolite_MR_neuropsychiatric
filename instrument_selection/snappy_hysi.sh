#!/bin/bash
#SBATCH --job-name=snappy_matched_hysi_all
#SBATCH --output=/scratch/prj/proitsi/lachlan/PhD_project_2/snappy/snappy_out/hysi_proxies/snappy_matched_hysi_all.log
#SBATCH --mem=20G
#SBATCH --nodes=1
#SBATCH --ntasks=12
...
INSTRUMENT_FILE_DIR="/scratch/prj/proitsi/lachlan/PhD_project_2/snappy/hysi_instruments"
FILE_DIR="/scratch/prj/proitsi/lachlan/PhD_project_2/snappy/snappy_snps/snappy_snps_hysi"
...
PLINK_MIN_R2=0.8
OUTPUT_DIRECTORY="/scratch/prj/proitsi/lachlan/PhD_project_2/snappy/snappy_out/hysi_proxies"
...
# sbatch -p cpu /scratch/prj/proitsi/lachlan/PhD_project_2/scripts/snappy_hysi_all.sh
